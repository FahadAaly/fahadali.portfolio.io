        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              />
              <h1 id="colorlib-logo">
                <a href="index.html">Fahad Ali Siddiqui</a>
              </h1>
              <span className="email">
                <i className="icon-mail"></i> fali13367@gmail.com
              </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/FahadAli05/"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/fahad-ali-885154159/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
